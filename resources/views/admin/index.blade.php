...
{!! HTML::script("/js/adminIndex.js") !!}
@stop


@section("body")

@include("admin-layouts.menuAdmin", array("link" => "dashboard", "has_sublink" => 0, "sublink" => ""))
...
<div id="dashboard" class="container">
	...
	<ul class="small-block-grid-2 medium-block-grid-2 large-block-grid-4 stat-block-group">
		...
		<li>
			<a href="{!! URL::route('adminImagePosts') !!}" class="count-block">
				<div class="ui-block align-center">
